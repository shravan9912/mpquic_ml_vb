...
- Changed the log level environment variable to only accept strings ("DEBUG", "INFO", "ERROR"), see [the wiki](https://github.com/shravan9912/mpquic_actor_critic_v1/wiki/Logging) for more details.
