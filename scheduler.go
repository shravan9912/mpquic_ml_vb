...
pathLoop:
	...
	if bestPath != nil && secondBestPath != nil {
		for sch.episoderecord < sch.record {
			...
			feature.Set(6, 0, sch.featuresix[sch.episoderecord])
...
func (sch *scheduler) selectPathDeploy_Bandit(s *session, hasRetransmission bool, hasStreamRetransmission bool, fromPth *path) *path {
...
func (sch *scheduler) selectPath(s *session, hasRetransmission bool, hasStreamRetransmission bool, fromPth *path) *path {
	...
	case constants.SCHEDULER_ROUND_ROBIN:
		return sch.selectPathRoundRobin(s, hasRetransmission, hasStreamRetransmission, fromPth)
	case constants.SCHEDULER_ROUND:
	...
	case constants.SCHEDULER_ACTOR_CRITIC:
		return sch.selectPathActorCritic(s, hasRetransmission, hasStreamRetransmission, fromPth)
	case constants.SCHEDULER_REDUNDANT:
		return sch.selectPathRedundant(s, hasRetransmission, hasStreamRetransmission, fromPth)
	case constants.SCHEDULER_DEPLOY_BANDIT:
		return sch.selectPathDeploy_Bandit(s, hasRetransmission, hasStreamRetransmission, fromPth)
